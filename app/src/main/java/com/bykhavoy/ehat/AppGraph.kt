...
class AppGraph(context: Context) {
    ...
    val placesStore = PlacesStore(appContext.appDataStore)

    @Volatile
    private var currentPlaces: List<Location> = Constants.LOCATIONS
    ...
    init {
        scope.launch { placesStore.places.collect { currentPlaces = it } }
    }
}
